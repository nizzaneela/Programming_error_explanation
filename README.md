...
The function `calculate_bf` takes an array of values as `simulation_results` and divides them by their sum to produce an array `pr_3_topos` - the probabilities for three topologies given a single introduction, i.e.:
```
